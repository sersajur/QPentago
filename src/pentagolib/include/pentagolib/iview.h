...
public:
    ...
    virtual void Draw_stone(int row, int col, color c)=0;/*draw stone at [row, col] with color*/
...
public:
    ...
    virtual void Join_game(string join_connect_data)=0;
    virtual void Host_game(string host_connect_data)=0;
